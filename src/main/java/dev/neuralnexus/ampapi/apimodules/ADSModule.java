...
public class ADSModule extends AMPAPI {
     ...
     * @return List<Map<String, Object>>
     */
    public List<Map<String, Object>> GetInstanceStatuses() {
        HashMap<String, Object> args = new HashMap<>();
        Type type = new TypeToken<List<Map<String, Object>>>(){}.getType();
        return (List<Map<String, Object>>) this.APICall("ADSModule/GetInstanceStatuses", args, type);
    }
     ...
     */
    public List<IADSInstance> GetInstances() {
        HashMap<String, Object> args = new HashMap<>();
     ...
     * @return List<Map<String, Object>>
     */
    public List<Map<String, Object>> GetProvisionArguments(String ModuleName) {
        HashMap<String, Object> args = new HashMap<>();
        args.put("ModuleName", ModuleName);
        Type type = new TypeToken<List<Map<String, Object>>>(){}.getType();
        return (List<Map<String, Object>>) this.APICall("ADSModule/GetProvisionArguments", args, type);
    }
     ...
     * @return Map<String, Object>
     */
    public Map<String, Object> Servers(String id, String REQ_RAWJSON) {
        HashMap<String, Object> args = new HashMap<>();
        args.put("id", id);
     ...
     * @return ActionResult
     */
    public ActionResult StartAllInstances() {
        HashMap<String, Object> args = new HashMap<>();
        Type type = new TypeToken<ActionResult>(){}.getType();
     ...
     * @return ActionResult
     */
    public ActionResult StopAllInstances() {
        HashMap<String, Object> args = new HashMap<>();
        Type type = new TypeToken<ActionResult>(){}.getType();
     ...
     * @return ActionResult
     */
    public ActionResult TestADSLoginDetails(String url, String username, String password) {
        HashMap<String, Object> args = new HashMap<>();
        args.put("url", url);
        args.put("username", username);
        args.put("password", password);
     ...
     * @return ActionResult
     */
    public ActionResult UpgradeAllInstances(Boolean RestartRunning) {
        HashMap<String, Object> args = new HashMap<>();
