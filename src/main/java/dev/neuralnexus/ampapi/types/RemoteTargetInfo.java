...
public class RemoteTargetInfo {
    ...
    public String toString() {
        return "RemoteTargetInfo{IPAddressList=" + Arrays.toString(this.IPAddressList) + ", PlatformInfo=" + this.PlatformInfo + ", Datastores=" + Arrays.toString(this.Datastores) + ", DeploysInContainers=" + this.DeploysInContainers + "}";
    }
}
