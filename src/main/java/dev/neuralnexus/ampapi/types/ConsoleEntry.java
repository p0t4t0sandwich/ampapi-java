...
public class ConsoleEntry {
     ...
     * SourceId - The source ID of the entry
    ...
    public String toString() {
        return "ConsoleEntry{Timestamp=" + this.Timestamp + ", Source=" + this.Source + ", SourceId=" + this.SourceId + ", Type=" + this.Type + ", Contents=" + this.Contents + "}";
    }
}
